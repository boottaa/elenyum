    ...
    template: `
      <div id="workSchedulePostDatePicker" class="mt-1">
        ...
        <div class="workSchedulePostDatePickerInner">
          <date-picker :editable="false" :time-picker-options="{start: start, step: '00:15', end: end}" aria-required="true" v-model="select" id="eventStart" @input="setSelected" style="width: 100%" type="time" :show-second="false" range></date-picker>
        </div>
      </div>
    `,
    methods: {
